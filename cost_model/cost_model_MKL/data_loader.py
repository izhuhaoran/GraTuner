...
class ScheduleDataset(Dataset):
    def __init__(self, graph_name, algo_name='pagerank'):
        file_path = f'{PROJECT_ROOT}/test/grouped/{graph_name}_{algo_name}.gt_output.csv'
...
class ScheduleDataset_all_algo(Dataset):
    ...
    def __getitem__(self, index):
        return self.algos[index], self.graphs[index], self.schedules[index], self.runtimes[index]
