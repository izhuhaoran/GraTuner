...
config_NUMA = ['false','static-parallel', 'static-parallel', 'dynamic-parallel']
...
class GraphItDataCreator():
  ...
  def compile(self, cfg, algo_file_, id):
      ...
      compile_graphit_cmd = 'python ' + py_graphitc_file +  ' -a {algo_file} -f {schedule_file} -i ../include/ -l ../build/lib/libgraphitlib.a -o test.cpp'.format(algo_file=algo_file_, schedule_file=self.new_schedule_file_name) 
                                    ...
                                    if result_time == None:
                                        ...
                                        with open(output_file_name, 'a') as file:
                                            ...
                                            for key, value in cfg.items(): 
                                                output_sche += f"{value}, "
                                            file.write(output_sche+str(result_time)+'\n')
