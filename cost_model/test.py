                ...
                for parallelization_option in config_parallelization:
                    ...
                    for DenseVertexSet_option in config_DenseVertexSet:
                        ...
                        if passed: # 如果能够通过过滤，则调度组合有效
                            ...
                            output_file_name = '/home/zhuhaoran/AutoGraph/AutoGraph/dataset/all_true_schedule.csv'
...
if __name__ == '__main__':
    # true_data_path = '/home/zhuhaoran/AutoGraph/AutoGraph/test/grouped/dblp-cite_pagerank.gt_output.csv'
    # true_all_data = pd.read_csv(true_data_path, comment='#', sep=',', header=None)
    
    # y = true_all_data[6].values
    # y = torch.tensor(y)
    
    # test_file_path = '/home/zhuhaoran/AutoGraph/AutoGraph/dataset/all_true_schedule.csv'
