...
class AutoGraphModel_NoAlgo(nn.Module):
    def __init__(self, in_dim=2, hidden_dim=128, out_dim=128) -> None:
        super(AutoGraphModel_NoAlgo, self).__init__()
...
class AutoGraphModel_OnlySche(nn.Module):
    def __init__(self, in_dim=2, hidden_dim=128, out_dim=128) -> None:
        super(AutoGraphModel_OnlySche, self).__init__()
