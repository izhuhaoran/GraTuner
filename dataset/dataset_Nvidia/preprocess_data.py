...
for algo in ["bfs", "pagerank", "sssp", 'cc']:
    input_path = f"{PROJECT_ROOT}/dataset_GPU/finetune/{algo}_new.gt_runtime.txt"
    output_path_train = f"{PROJECT_ROOT}/dataset_GPU/finetune_new/train/{algo}.csv"
    output_path_val = f"{PROJECT_ROOT}/dataset_GPU/finetune_new/val/{algo}.csv"
    convert_txt_to_csv3(input_path, output_path_train, output_path_val)


# for algo in ["bfs", "pagerank", "sssp", 'cc']:
#     input_path = f"{PROJECT_ROOT}/dataset_GPU/finetune/train/{algo}.csv"
#     output_path = f"{PROJECT_ROOT}/dataset_GPU/all_true_schedule_{algo}_GPU.csv"
#     extract_unique_schedules(input_path, output_path)

# input_file = "{PROJECT_ROOT}/dataset_GPU/finetune/train/pagerank.csv"
# output_file = "{PROJECT_ROOT}/dataset_GPU/all_schedule.csv"
# extract_unique_schedules(input_file, output_file)