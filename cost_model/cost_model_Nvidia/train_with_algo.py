...
# Configure logging
# logging.basicConfig(filename=f'{PROJECT_ROOT}/cost_model/cost_model_GPU/train_with_algo/trainlog_gcn_transformer.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
logger = get_logger("train_with_algo", f"{PROJECT_ROOT}/cost_model/cost_model_GPU/train_with_algo/trainlog_gcn_transformer.log")
