...
if __name__ == '__main__':
    ...
    compile_file_name = 'compile_2.cpp'
    ...
    if len(schedule_cmd_list) == 0:
        ...
        # compile and execute compile_2.cpp file to complete the compilation
        #TODO: code here uses very fragile relavtive paths, figure out a better way
        # Maybe setting environment variables
        try:
            subprocess.check_call(CXX_COMPILER + " -g -std=c++14 -I {0} {1} -o compile_2.o {2}".format(runtime_include_path, compile_file_name, graphitlib_path), stderr=subprocess.STDOUT, shell=True)
        except subprocess.CalledProcessError as e:
            print(e.output)
            raise
        COMPILER_BINARY = "./compile_2.o"
