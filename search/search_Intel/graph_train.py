...
output_dir = f'{PROJECT_ROOT}/search/search_Intel/trained_graph'
...
def read_runtime_dict():
    ...
    for algo in ["bfs", "pagerank", "sssp", 'cc']:
        file_path = f"{PROJECT_ROOT}/dataset/dataset_Intel/finetune/train/{algo}.csv"
...
def q_learning_train(knn_graph, algo_name, graphid, model=None):
    ...
    schedules_origin, schedules_data = read_all_schedules(f"{PROJECT_ROOT}/search_Intel/all_true_schedule_{algo_name}.csv")
...
if __name__ == "__main__":
    ...
    for algo in algo_list:
        for graphid in range(graph_num):
            knn_graph = load_knn_graph(f"{PROJECT_ROOT}/search_Intel/init_graph/knn_graph_init_{algo}.pkl")
